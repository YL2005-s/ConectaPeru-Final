...
public class RegisterEnterpriseView extends JPanel {
    ...
    public RegisterEnterpriseView() {
        ...
        card.setMaximumSize(new Dimension(500, 650));

        make_header(card);
        make_fields(card);
        btn_register = make_btn("Registrar Empresa");
    ...
    private void make_header(JPanel parent) {
        JLabel lblTitle = new JLabel("Registro - Empresa");
        lblTitle.setFont(new Font("SansSerif", Font.BOLD, 22));
        lblTitle.setForeground(new Color(40, 40, 40));
        lblTitle.setAlignmentX(CENTER_ALIGNMENT);

        JLabel lblSubtitle = new JLabel("Completa los campos requeridos para registrar tu empresa");
    ...
    private void make_fields(JPanel parent) {
        String[] labels = {
                "DNI", "Correo", "Contraseña", "Teléfono",
                "Nombre Empresa", "Descripción", "Ubicación"
        };
    ...
    private JButton make_btn(String texto) {
    ...
    public String getCampo(String nombre) {
        return textFields.get(nombre).getText().trim();
    }
